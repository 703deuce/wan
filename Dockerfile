...
# transformers 4.51.3 (installed by Wan2.2) should have modeling_layers (>=4.44.0)
# Use peft 0.13.0+ which supports modeling_layers but is compatible with transformers 4.51.3
# This version works with diffusers 0.31+ and transformers 4.44-4.51.3
RUN pip3 install --no-cache-dir "peft>=0.13.0,<0.18.0"
